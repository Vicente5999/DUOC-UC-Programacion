...
public class Main {
   ...
   public static void main(String[] args) {
        ...
        Guias registroGuias = new Guias("", "", direccionGuias);
        ...
        ServicioTuristico registroServicioTuristico = new ServicioTuristico("", 0);
        ...
        //ServicioTuristico tour = new ServicioTuristico("", 0);
        GestorServicios mostrarLista = new GestorServicios();
        ...
        try (Scanner input = new Scanner(System.in)) {
            ...
            // Registro de Servicio Turistico
            System.out.println("\n--- Registro Tour ---");
            System.out.println("Ingrese nombre del Servicio Turistico:");
            registroServicioTuristico.setNombre(input.nextLine());
            System.out.println("Ingrese duración en Horas del Servicio Turistico:");
            registroServicioTuristico.setDuracionHoras(input.nextInt());
            ...
            System.out.println("Ingrese número de paradas en el Paseo Lacustre:");
            ...
            System.out.println("Ingrese el tipo de embarcación de la Excursion Cultural:");
            ...
            System.out.println(registroServicioTuristico.toString());
            ...
            System.out.println(mostrarLista.getLista());
            
                  
            GestorServicios.datosTour(
            ...
            do {
                ...
                if (verResultadoFinal.equalsIgnoreCase("si")) {
                    ...
                    try {
                        File archivo = new File(GestorServicios.archivoDatos);
